...
public class CORSFilter implements ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext, ContainerResponseContext responseContext) {
        ...
        if(host != null && (host.equalsIgnoreCase("http://localhost") ||
                host.equalsIgnoreCase("http://handycrab.nico-dreher.de") || host.equalsIgnoreCase("http://127.0.0.1") ||
                host.equalsIgnoreCase("http://[::1]"))) {
